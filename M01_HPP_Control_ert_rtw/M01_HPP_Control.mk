###########################################################################
## Makefile generated for Simulink model 'M01_HPP_Control'. 
## 
## Makefile     : M01_HPP_Control.mk
## Generated on : Sun Sep 18 17:29:48 2022
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/M01_HPP_Control.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/pavel.dushkin/Documents/_ПавелКоролёв
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = M01_HPP_Control_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = M01_HPP_Control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/M01_HPP_Control.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/M01_HPP_Control_ert_rtw -I$(START_DIR)/SModels -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=M01_HPP_Control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/M01_HPP_Control_ert_rtw/M01_HPP_Control.c
...
%.obj : $(START_DIR)/M01_HPP_Control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/M01_HPP_Control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
